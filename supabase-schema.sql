...
--     installer_name, device_number, court_name, full_name, dob, phone, address, city, zip
-- ) VALUES (
--     'John Smith', '12345678', 'Pulaski County Court', 'Jane Doe', '1990-01-01', '555-1234', '123 Main St', 'Little Rock', '72201'
-- );
...
-- GRANT ALL ON agreement_submissions TO authenticated;
-- GRANT ALL ON file_uploads TO authenticated;
-- GRANT SELECT ON audit_logs TO authenticated;
-- GRANT SELECT ON agreement_summary TO authenticated;
